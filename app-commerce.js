  ...
  grid.innerHTML = products.map(p => {
    ...
    return `<div class="mkt-product-card" onclick="openProductPage('${p.id}')">
      ...
      <div class="mkt-product-body">
        ${store ? `<div class="mkt-product-store-row">
          ${logo ? `<img src="${escHtml(logo)}" class="mkt-product-store-logo" alt="">` : ''}
          <span class="mkt-product-store">${store}</span>
        </div>` : ''}
